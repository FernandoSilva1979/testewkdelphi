...
begin
  ...
  begin
     try
       ...
       begin
         sql.Add('INSERT INTO clientes (nome,cidade,uf) '
...
begin
  ...
  begin
     try
       ...
       close;
       sql.clear;
        if (tipo='lista') then                                                // sql de busca de clientes
       ...
       while not eof do
         begin
           templistacliente.FListaClientes.Add(Tclientes.Create);                     // preecher a lista de objetos de clientes com resultado da sql
